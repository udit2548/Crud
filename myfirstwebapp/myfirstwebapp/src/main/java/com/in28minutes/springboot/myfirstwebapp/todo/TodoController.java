...
public class TodoController {
	...
	// spring form tag libraries <form:form> form:input type="text" path="description" etc
// BindingResult is simply to avoid that large error page and simplify the text shown	
